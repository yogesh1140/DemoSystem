...
using MedicalManagementSystem.Authorization;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("MedicalManagementSystem")));
            ...
            services.AddIdentityServer()
                ...
                {
                    options.ConfigureDbContext = builder => builder.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("MedicalManagementSystem"));
                })
